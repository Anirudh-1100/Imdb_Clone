    ...
    <>
      <div className="flex justify-center flex-wrap m-4">
        {genres.map((genre) => (
          <button
            ...
            className={`h-12 px-4 rounded-xl text-white font-bold mx-2 my-1 transition-colors ${
              currentGenre === genre
                ? "bg-blue-600"
      ...
      <div className="flex justify-center items-center my-4 space-x-4">
        <input
          ...
          className="h-12 w-72 bg-gray-200 outline-none px-4 rounded-lg"
          value={searchTerm}
        ...
        <div className="flex items-center space-x-2 text-lg text-gray-600">
          <i
            ...
            className={`fa-solid fa-arrow-down-z-a p-2 rounded-full cursor-pointer hover:bg-gray-200 ${
              sortOrder === "desc" ? "text-blue-600" : ""
            }`}
          ></i>
          <i
            onClick={() => setSortOrder("asc")}
            className={`fa-solid fa-arrow-up-a-z p-2 rounded-full cursor-pointer hover:bg-gray-200 ${
              sortOrder === "asc" ? "text-blue-600" : ""
            }`}
          ></i>
        </div>
      </div>
